...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        persistWebViewCookieToPersistentCookieJar("bilibili.com")
        ...
        webView!!.webViewClient = object : WebViewClient() {
            ...
            override fun shouldInterceptRequest(view: WebView?, request: WebResourceRequest?): WebResourceResponse? {
                ...
                if (url.equals("https://api.bilibili.com/x/web-interface/nav")) {
                    Log.d(TAG, "persistWebViewCookieToPersistentCookieJar: "+url)
                    // 拦截登录成功后的跳转请求返回主页，同时保存cookies
                    Handler(Looper.getMainLooper()).postDelayed({
                        persistWebViewCookieToPersistentCookieJar("bilibili.com")
                    }, 500) // 延迟 500ms，避免 Cookie 未同步
    ...
    fun persistWebViewCookieToPersistentCookieJar(domain: String) {
        ...
        val okHttpCookieList = parseWebViewCookieToOkHttp(webViewCookieStr, domain)
