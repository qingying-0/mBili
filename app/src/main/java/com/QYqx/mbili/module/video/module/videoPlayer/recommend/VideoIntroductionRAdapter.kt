...
import com.QYqx.mbili.databinding.ItemVideoPlayerRecommendBinding
 ...
 */
class VideoIntroductionRAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_video_player_recommend, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        val videoCard = cardList[position]
        ...
        // 条目点击事件
        cardHolder.binding.constraintLayout.setOnClickListener {
    ...
    class CardHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val binding: ItemVideoPlayerRecommendBinding = ItemVideoPlayerRecommendBinding.bind(itemView)
    }
